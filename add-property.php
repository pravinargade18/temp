...
<head>
    ...
    <title>Hostellers || Add Property</title>
</head>
<script>
    ...
    echo $msg;
              ...
              ?>      
                  ...
                  <?php } ?>
                                    ...
                                    <div class="col-xs-12 col-sm-4 col-md-4">
                                        <div class="form-group">
                                            <label for="After-Price-Label">Enter Property Google Map link</label>
                                            <input type="text" class="form-control" name="afterpricelabel" id="afterpricelabel" placeholder="ex: https://goo.gl/maps/PQztLDZuk7XjmbkHA">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-4 col-md-4">
                                        <div class="form-group">
                                            <label for="After-Price-Label">Enter Property address or google map embed link</label>
                                            <input type="text" class="form-control" name="propertylink" id="propertylink" placeholder="https://www.google.com/map...!2Sin">
                                        </div>
                                    </div>
